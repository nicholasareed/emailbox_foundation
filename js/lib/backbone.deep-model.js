...
;(function(factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['underscore-adapter', 'backbone'], factory);
    } else if (typeof exports === 'object') {
        // CommonJS
        module.exports = factory(require('underscore-adapter'), require('backbone'));
    } else {
        // globals
        factory(_, Backbone);
    }
    ...
    var DeepModel = Backbone.Model.extend({
        ...
        toJSON: function(options) {
          var that = this;
          // Make sure to run Backbone.toJSON also?
          var json = _.deepClone(this.attributes);
